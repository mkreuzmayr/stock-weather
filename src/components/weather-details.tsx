...
import { Wind, Droplets, Eye, Moon, ArrowUp, ArrowDown } from "lucide-react"
...
export function WeatherDetails({ weatherData }: WeatherDetailsProps) {
  return (
    <div className="mt-8 bg-gray-100 dark:bg-gray-900 rounded-3xl p-4">
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900 dark:text-gray-100">{weatherData.visibility}</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            <div className="mt-1 p-2 rounded-full bg-amber-100 dark:bg-amber-900/30">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900 dark:text-gray-100">{weatherData.sunrise}</p>
            </div>
          </div>

          <div className="flex items-start gap-3">
            <div className="mt-1 p-2 rounded-full bg-indigo-100 dark:bg-indigo-900/30">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900 dark:text-gray-100">{weatherData.sunset}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900 dark:text-gray-100">{weatherData.moonPhase}</p>
            </div>
          </div>
        </div>
      </div>
