...
export function StockForecast() {
  ...
  const forecast = [
    { day: "TODAY", trend: "up", condition: "sunny", high: 183.25, low: 180.15 },
    { day: "TUE", trend: "up", condition: "sunny", high: 185.4, low: 182.3 },
    { day: "WED", trend: "down", condition: "cloudy", high: 184.75, low: 181.2 },
      ...
      <div className="flex justify-between items-center mb-4">
        {forecast.map((day, index) => (
          <div key={index} className="flex flex-col items-center">
            ...
            <div className="text-sm font-bold text-gray-900 dark:text-gray-100">{day.high.toFixed(1)}</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">{day.low.toFixed(1)}</div>
          </div>
        ))}
